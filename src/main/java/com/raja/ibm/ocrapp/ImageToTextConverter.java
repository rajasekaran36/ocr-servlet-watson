...
public class ImageToTextConverter extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        HttpPost httpPost = new HttpPost("http://max-ocr.codait-prod-41208c73af8fca213512856c7a09db52-0000.us-east.containers.appdomain.cloud/model/predict");
        ...
        resp.getWriter().println(EntityUtils.toString(entity));
        f.delete();
    }
}